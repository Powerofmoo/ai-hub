...
DEFAULT_CONFIG = {
    ...
    "ui": {
        "default_locale": "",
          "bangla_prompt_suggestions": [
            {
                "title": [
                    "How can i fund my AI startup",
                    "practical tips",
                ],
                "content": "How can i fund my AI startup",
            },
            {
            "title": [
                    "Give me some ideas for my next LabLab hackathon",
                    "award winning ideas",
                ],
                "content": "Give me some ideas for my next LabLab hackathon",
            },
            {
            "title": [
                    "How do i deal with harassment on the street",
                    "i wanna feel safe",
                ],
                "content": "How do i deal with harassment on the street in Bangladesh"
            }
        ],
        "artic_prompt_suggestions": [
            {
                "title": [
                    "What to do with frozen fingers",
                    "a first aid",
                ],
                "content": "Give me practical tips for frozen fingers",
            },
            {
            "title": [
                    "Ways to have fun with a snow scooter",
                    ":)",
                ],
                "content": "Give me some fun ways to ride a snow scooter",
            },
            {
            "title": [
                    "What are the effects of climate change on the artics",
                    "from small to big",
                ],
                "content": "Give me extended list of climate change consequences for the artics"
            }
        ],
        "prompt_suggestions": [
            {
                ...
                "content": "Give some practical options how i could learn AI with the new local AI-Hub server",
            },
            {
            "title": [
                    "How can i practice NVC in though situations",
                    "with real life examples",
                ],
                "content": "Explain the principles of NVC and give some real life examples in a refugee camp",
            },
            {
            "title": [
                    "How can i recycle an old ....",
                    "everything can be reused",
                ],
                "content": "Suggest creative ways to reuse resources"
            }
        ],
        "orig_prompt_suggestions": [
            {
                "title": [
                    "Help me study",
